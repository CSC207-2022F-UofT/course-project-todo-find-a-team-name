...
public class TestCalculateSectionHoursInteractor {
    ...
    private final CalculateSectionHoursInteractor calculateSectionHoursInteractor = new CalculateSectionHoursInteractor();
    ...
    public void test_calculateHoursOfSection_terrible_arguments_too_huge() {
        ...
        assertThrows(IllegalArgumentException.class, () ->
                calculateSectionHoursInteractor.calculateHoursOfSection(testSection));
    }
