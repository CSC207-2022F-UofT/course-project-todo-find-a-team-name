...
public class TimetableCourseGenerator{
     ...
     * sections of calenderCourse, which has no time conflict between sections in the course
     *
     ...
     */
    public List<TimetableCourse> generateAllTimetableCourses(){
     ...
     * that can be generated from the given lectures, tutorials, and practicals, that has no time conflict
     ...
     * from index, depth to sections.size()-1, to curr, where there are no time conflict between sections in the course
     *
